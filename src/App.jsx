...
import { ParametresPage } from "./components/comptabilite-matieres/ParametresPage";
import { PvPage } from "./components/comptabilite-matieres/PvPage";
import { DemandePage } from "./components/services/DemandePage";
import { StatistiquesComptaPage } from "./components/comptabilite-matieres/StatistiquesComptaPage";
...
export default function App(){
  ...
  const renderPage=()=>{
    ...
    switch(page){
      ...
      case "statistiques-compta": return (can(user,"statistiques-fonct","r")||can(user,"statistiques-np","r"))?<StatistiquesComptaPage store={store} activeSupplier={activeSupplier} currentUser={user}/>:<div style={{padding:24}}><Alert type="error">Accès non autorisé.</Alert></div>;
      case "parametres-pv": return can(user,"parametres-pv","r")?<ParametresPage store={store} currentUser={user}/>:<div style={{padding:24}}><Alert type="error">Accès non autorisé.</Alert></div>;
      case "pv": return (can(user,"entrees-fonct","r")||can(user,"entrees-np","r"))?<PvPage store={store} currentUser={user}/>:<div style={{padding:24}}><Alert type="error">Accès non autorisé.</Alert></div>;
      case "demandes": return can(user,"demandes","r")?<DemandePage store={store} currentUser={user}/>:<div style={{padding:24}}><Alert type="error">Accès non autorisé.</Alert></div>;
