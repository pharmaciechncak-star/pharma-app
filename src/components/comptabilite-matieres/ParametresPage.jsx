    ...
    <div style={{padding:0}}>
      ...
      <div style={{padding:16}}>
        ...
        <div style={{...card,marginBottom:16}}>
          <div style={{fontWeight:700,fontSize:13,color:"#1e293b",marginBottom:4}}>🔀 Circuit — {COMPTA_CIRCUITS[circuit].label}</div>
        ...
        {/* ── Circuits (admin uniquement) ── */}
        {isAdmin&&(
          <div style={{...card,marginBottom:16}}>
            <div style={{fontWeight:700,fontSize:13,color:"#1e293b",marginBottom:4}}>🔀 Circuits</div>
        ...
        {/* ── Types de produits ── */}
        <div style={{...card,marginBottom:16}}>
          <div style={{fontWeight:700,fontSize:13,color:"#1e293b",marginBottom:4}}>📦 Types de produits</div>
        ...
        <div style={{...card,marginBottom:16}}>
          <div style={{fontWeight:700,fontSize:13,color:"#1e293b",marginBottom:4}}>👥 Responsables — {COMPTA_CIRCUITS[circuit].label}</div>
